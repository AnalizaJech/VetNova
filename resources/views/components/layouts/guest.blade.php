<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="vetneolink">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ $title ?? 'VetNeoLink — Acceso' }}</title>
...
<body class="min-h-screen font-sans antialiased bg-base-200">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div class="flex items-center gap-3 mb-8">
            ...
            <div>
                <h1 class="text-2xl font-bold font-heading tracking-tight text-base-content">VetNeoLink</h1>
        ...
        <p class="mt-8 text-xs text-base-content/40">
            &copy; {{ date('Y') }} VetNeoLink · Hecho en Perú 🇵🇪
        </p>
    </div>
